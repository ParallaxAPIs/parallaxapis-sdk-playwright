# <img src="https://github.com/ParallaxAPIs/.github/blob/main/profile/logo.png" alt="Parallax Logo" width="30" height="30" style="vertical-align: middle;"> ParallaxAPIs SDK - Playwright Library for Bot Protection Bypass (Datadome & PerimeterX)


![license MIT](https://img.shields.io/static/v1?label=license&message=MIT&color=99cc33&labelColor=555555) ![Node.js version](https://img.shields.io/static/v1?label=Node.js&message=17%2B&color=007ec6&labelColor=555555) ![downloads](https://img.shields.io/static/v1?label=downloads&message=1.1k%2Fmonth&color=brightgreen&labelColor=555555)
